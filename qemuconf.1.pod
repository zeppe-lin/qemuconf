...
B<qemuconf> [B<-q> I<PATH>] I<CONFIG> [-- QEMU OPTIONS ...]
...
Set the default path to L<qemu(1)> binary.  This option may be
overwritten by the I<binary> option in the configuration file.
